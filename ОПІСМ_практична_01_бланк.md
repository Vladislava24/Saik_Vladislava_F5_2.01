...
| IP-адреса |172.67.137.191; 104.21.46.99 |172.67.137.191
                104.21.46.99 |
...
```
що мені потрібно написати там де вивід? |
| 2 | Частина В| **Рядки, які не вдалося віднести до жодної групи:**
як це зрозуміти?|
...
| 2 | Чи підходить відповідь до моєї роботи| Скоротила відповідь |
Зайву інформацію не використала |
| 3 | Чи правильно я зрозуміла результат|Переписала своїми словами|
Те, що не відповідало моїй ситуації, не використала |
